...
from data.dataset_GraphNet import GraphNetDataset
...
def train(**kwargs):
    ...
    junc_train_data = GraphNetDataset(data_root=GraphNet_opt.train_data_root, Label_model_pth=GraphNet_opt.Label_model_pth,mask_size=GraphNet_opt.mask_size,process_splits=GraphNet_opt.process_splits)
    junc_train_data_hard_soft=GraphNetDataset(data_root=GraphNet_opt.train_data_root, Label_model_pth=GraphNet_opt.Label_model_pth, mask_size=GraphNet_opt.mask_size,button=1,process_splits=GraphNet_opt.process_splits)
    junc_train_data_hard_hard=GraphNetDataset(data_root=GraphNet_opt.train_data_root, Label_model_pth=GraphNet_opt.Label_model_pth, mask_size=GraphNet_opt.mask_size,button=2,process_splits=GraphNet_opt.process_splits)


    junc_val_data = GraphNetDataset(data_root=GraphNet_opt.val_data_root, Label_model_pth=GraphNet_opt.Label_model_pth, mask_size=GraphNet_opt.mask_size)
