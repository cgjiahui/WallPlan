...
from data import LabelNetApplicationDataset
...
def train(**kwargs):
    ...
    seman_train_data = LabelNetApplicationDataset(data_root=LabelNet_opt.train_data_root, mask_size=LabelNet_opt.mask_size)
    seman_val_data = LabelNetApplicationDataset(data_root=LabelNet_opt.val_data_root, mask_size=LabelNet_opt.mask_size)
